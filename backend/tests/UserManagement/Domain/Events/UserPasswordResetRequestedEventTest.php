...
class UserPasswordResetRequestedEventTest extends TestCase
{
    ...
    public function testFromArray(): void
    {
        ...
        $this->assertEquals($data['passwordResetToken'], $event->getPasswordResetToken());
        $this->assertEquals($data['passwordResetTokenExpiry'], $event->getPasswordResetTokenExpiry()->format(\DateTimeInterface::ATOM));
