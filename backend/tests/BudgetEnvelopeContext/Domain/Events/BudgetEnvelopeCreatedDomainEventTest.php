...
class BudgetEnvelopeCreatedDomainEventTest extends TestCase
{
    public function testToArray(): void
    {
        $event = new BudgetEnvelopeCreatedDomainEvent('b7e685be-db83-4866-9f85-102fac30a50b', '1ced5c7e-fd3a-4a36-808e-75ddc478f67b', 'Test', '1000.00');
        $array = $event->toArray();
    ...
    public function testFromArray(): void
    {
        ...
        $event = BudgetEnvelopeCreatedDomainEvent::fromArray($data);
