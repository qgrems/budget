...
class EnvelopeNamedEventTest extends TestCase
{
    public function testToArray(): void
    {
        $event = new EnvelopeNamedEvent('b7e685be-db83-4866-9f85-102fac30a50b', 'Test Name');
        $array = $event->toArray();
    ...
    public function testFromArray(): void
    {
        ...
        $event = EnvelopeNamedEvent::fromArray($data);
