...
final readonly class BudgetEnvelopeDebitedNotificationEvent
{
    ...
    private function __construct(
        ...
        $this->type = 'BudgetEnvelopeDebited';
    }

    public static function fromDomainEvent(BudgetEnvelopeDebitedDomainEvent $budgetEnvelopeDebitedDomainEvent): self
    {
        return new self(
