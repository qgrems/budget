...
final readonly class AdjustABudgetPlanSavingCommand implements CommandInterface
{
    ...
    public function getCategory(): BudgetPlanSavingCategory
    {
        return BudgetPlanSavingCategory::fromString($this->category);
    }
