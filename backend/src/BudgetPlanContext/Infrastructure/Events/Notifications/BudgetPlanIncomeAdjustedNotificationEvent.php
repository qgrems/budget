...
final readonly class BudgetPlanIncomeAdjustedNotificationEvent
{
    ...
    private function __construct(
        ...
        $this->type = 'BudgetPlanIncomeAdjusted';
    }
    ...
    public static function fromBudgetPlanIncomeAdjustedDomainEvent(
        BudgetPlanIncomeAdjustedDomainEvent $budgetPlanIncomeAdjustedDomainEvent,
    ): self {
        return new self(
            $budgetPlanIncomeAdjustedDomainEvent->aggregateId,
            $budgetPlanIncomeAdjustedDomainEvent->userId,
            $budgetPlanIncomeAdjustedDomainEvent->requestId,
        );
    }
