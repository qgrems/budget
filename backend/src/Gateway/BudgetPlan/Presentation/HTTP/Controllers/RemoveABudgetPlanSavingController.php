...
#[Route('/api/budget-plans/{budgetPlanUuid}/remove-saving/{uuid}', name: 'app_budget_plan_remove_saving', methods: ['DELETE'])]
#[IsGranted('ROLE_USER')]
final readonly class RemoveABudgetPlanSavingController
{
    ...
    public function __invoke(
        ...
        $this->commandBus->execute(new RemoveABudgetPlanSavingCommand(
