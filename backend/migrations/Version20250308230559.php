...
final class Version20250308230559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE budget_plan_income_entry_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, budget_plan_uuid VARCHAR(36) NOT NULL, income_name VARCHAR(35) NOT NULL, income_amount VARCHAR(13) NOT NULL, category VARCHAR(35) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_6EBA23A7D17F50A6 (uuid), INDEX idx_budget_plan_income_entry_view_uuid (uuid), INDEX idx_budget_plan_income_entry_budget_plan_view_uuid (budget_plan_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE budget_plan_need_entry_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, budget_plan_uuid VARCHAR(36) NOT NULL, need_name VARCHAR(35) NOT NULL, need_amount VARCHAR(13) NOT NULL, category VARCHAR(35) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_C103D027D17F50A6 (uuid), INDEX idx_budget_plan_need_entry_view_uuid (uuid), INDEX idx_budget_plan_need_entry_budget_plan_view_uuid (budget_plan_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE budget_plan_saving_entry_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, budget_plan_uuid VARCHAR(36) NOT NULL, saving_name VARCHAR(35) NOT NULL, saving_amount VARCHAR(13) NOT NULL, category VARCHAR(35) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_1BFB9A9AD17F50A6 (uuid), INDEX idx_budget_plan_saving_entry_view_uuid (uuid), INDEX idx_budget_plan_saving_entry_budget_plan_view_uuid (budget_plan_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE budget_plan_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, user_uuid VARCHAR(36) NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, currency VARCHAR(3) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_3A47CFDCD17F50A6 (uuid), INDEX idx_budget_plan_view_user_uuid (user_uuid), INDEX idx_budget_plan_view_uuid (uuid), INDEX idx_budget_plan_view_date (date), UNIQUE INDEX unique_budget_plan_for_user (user_uuid, date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE budget_plan_want_entry_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, budget_plan_uuid VARCHAR(36) NOT NULL, want_name VARCHAR(35) NOT NULL, want_amount VARCHAR(13) NOT NULL, category VARCHAR(35) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_16E8543D17F50A6 (uuid), INDEX idx_budget_plan_want_entry_view_uuid (uuid), INDEX idx_budget_plan_want_entry_budget_plan_view_uuid (budget_plan_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_store (id INT AUTO_INCREMENT NOT NULL, stream_id VARCHAR(36) NOT NULL, user_id VARCHAR(36) NOT NULL, event_name VARCHAR(255) NOT NULL, stream_version INT DEFAULT 0 NOT NULL, stream_name VARCHAR(255) NOT NULL, request_id VARCHAR(36) NOT NULL, payload JSON NOT NULL, meta_data JSON NOT NULL, occurred_on DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX idx_stream_id (stream_id), INDEX idx_stream_name (stream_name), INDEX idx_event_name (event_name), INDEX idx_user_id (user_id), INDEX idx_occurred_on (occurred_on), UNIQUE INDEX unique_stream_version (stream_id, stream_version), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
