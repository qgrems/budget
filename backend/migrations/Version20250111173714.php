...
final class Version20250111173714 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'This migration will creates the tables for the budget envelope and user views, the event store, and the refresh tokens.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE budget_envelope_history_view (id INT AUTO_INCREMENT NOT NULL, budget_envelope_uuid VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL, monetary_amount VARCHAR(13) NOT NULL, transaction_type VARCHAR(6) NOT NULL, user_uuid VARCHAR(36) NOT NULL, INDEX idx_budget_envelope_history_view_budget_envelope_uuid (budget_envelope_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_store (id INT AUTO_INCREMENT NOT NULL, aggregate_id VARCHAR(36) NOT NULL, type VARCHAR(255) NOT NULL, payload JSON NOT NULL, occurred_on DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX idx_aggregate_id (aggregate_id), INDEX idx_occurred_on (occurred_on), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
