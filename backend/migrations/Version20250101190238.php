...
final class Version20250101190238 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'This migration creates the tables for the views and the event store';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE budget_envelope_view (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, current_budget VARCHAR(13) NOT NULL, target_budget VARCHAR(13) NOT NULL, name VARCHAR(50) NOT NULL, user_uuid VARCHAR(36) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_3C39B684D17F50A6 (uuid), INDEX idx_envelope_view_user_uuid (user_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
