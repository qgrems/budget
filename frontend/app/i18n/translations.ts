export const translations = {
    en: {
        ...
        envelopes: {
            ...
            nameInvalid:
                "The name can only contain letters (including letters with accents), numbers (0-9), and spaces. No special characters are allowed.",
            ...
            targetedAmountInvalid:
                'The targeted amount must be a string representing a number with up to two decimal places (e.g., "0.00").',
            ...
            validationError: {
                ...
                targetBudgetLessThanCurrentAmount:
                    "The targeted amount is less than the current amount, modification not possible.",
        ...
        budgetTracker: {
            ...
            subtitle: "Plan your finances with the 50/30/20 rule",
            createNew: "Create New Budget Plan",
            calendar: "Budget Calendar",
            noBudgetSelected: "No Budget Plan Selected",
            selectMonthOrCreate: "Select a month from the calendar or create a new budget plan",
            ...
            totalWants: "Total Wants",
            totalSavings: "Total Savings",
            ofIncome: "of income",
            needsDescription: "Essential expenses that you can't avoid (50% of income)",
            wantsDescription: "Non-essential expenses that improve your quality of life (30% of income)",
            savingsDescription: "Money set aside for future goals and emergencies (20% of income)",
            createBudgetPlan: "Create Budget Plan",
            createBudgetPlanDescription: "Create a new budget plan based on the 50/30/20 rule",
            month: "Month",
            currency: "Currency",
            ...
            createFromExisting: "Use Existing Plan",
            createFromExistingDescription: "Create a new budget plan based on an existing one",
            targetMonth: "Target Month",
            selectExistingPlan: "Select Existing Plan",
            noExistingPlans: "No existing budget plans found",
            cancel: "Cancel",
            salary: "Salary",
            fetchCalendarError: "Failed to fetch budget calendar",
            fetchPlanError: "Failed to fetch budget plan",
            createSuccess: "Budget plan created successfully",
            createError: "Failed to create budget plan",
            createFromExistingSuccess: "Budget plan created from existing plan",
            createFromExistingError: "Failed to create budget plan from existing plan",
            addItem: "Add Item",
            editItem: "Edit Item",
            ...
            needAdjusted: "Need updated successfully",
            needRemoved: "Need removed successfully",
            wantAdded: "Want added successfully",
            wantAdjusted: "Want updated successfully",
            wantRemoved: "Want removed successfully",
            savingAdded: "Saving added successfully",
            savingAdjusted: "Saving updated successfully",
            savingRemoved: "Saving removed successfully",
            incomeAdded: "Income added successfully",
            incomeAdjusted: "Income updated successfully",
            incomeRemoved: "Income removed successfully",

            // Error messages
            needAddError: "Failed to add need",
            needAdjustError: "Failed to update need",
            needRemoveError: "Failed to remove need",
            wantAddError: "Failed to add want",
            wantAdjustError: "Failed to update want",
            wantRemoveError: "Failed to remove want",
            savingAddError: "Failed to add saving",
            savingAdjustError: "Failed to update saving",
            savingRemoveError: "Failed to remove saving",
            incomeAddError: "Failed to add income",
            incomeAdjustError: "Failed to update income",
            incomeRemoveError: "Failed to remove income",
            yearlyOverview: "Yearly Overview for {{year}}",
            incomesBreakdown: "Incomes Breakdown",
            needsBreakdown: "Needs Breakdown",
            wantsBreakdown: "Wants Breakdown",
            savingsOverTime: "Savings Over Time",
            debtRatio: "Debt Ratio",
            debtRatioDescription: "Percentage of total expenses to total income",
            totalSavings: "Total Savings",
            totalSavingsDescription: "Cumulative savings for the year",
        },
    },
    fr: {
        home: {
        ...
        envelopes: {
            ...
            nameInvalid:
                "Le nom ne peut contenir que des lettres (y compris des lettres avec accents), des chiffres (0-9) et des espaces. Aucun caractère spécial n'est autorisé.",
            ...
            targetedAmountInvalid:
                'Le budget cible doit être une chaîne représentant un nombre avec jusqu\'à deux décimales (par exemple, "0.00").',
        ...
        budgetTracker: {
            ...
            subtitle: "Planifiez vos finances avec la règle 50/30/20",
            createNew: "Créer un Nouveau Plan Budgétaire",
            calendar: "Calendrier Budgétaire",
            noBudgetSelected: "Aucun Plan Budgétaire Sélectionné",
            selectMonthOrCreate: "Sélectionnez un mois dans le calendrier ou créez un nouveau plan budgétaire",
            ...
            totalWants: "Total des Envies",
            totalSavings: "Total des Épargnes",
            ofIncome: "du revenu",
            needsDescription: "Dépenses essentielles que vous ne pouvez pas éviter (50% du revenu)",
            wantsDescription: "Dépenses non essentielles qui améliorent votre qualité de vie (30% du revenu)",
            savingsDescription: "Argent mis de côté pour des objectifs futurs et des urgences (20% du revenu)",
            createBudgetPlan: "Créer un Plan Budgétaire",
            createBudgetPlanDescription: "Créer un nouveau plan budgétaire basé sur la règle 50/30/20",
            month: "Mois",
            currency: "Devise",
            addIncome: "Ajouter un Revenu",
            removeIncome: "Supprimer le Revenu",
            incomeName: "Nom du Revenu",
            createPlan: "Créer le Plan",
            createFromExisting: "Utiliser un Plan Existant",
            createFromExistingDescription: "Créer un nouveau plan budgétaire basé sur un plan existant",
            targetMonth: "Mois Cible",
            selectExistingPlan: "Sélectionner un Plan Existant",
            noExistingPlans: "Aucun plan budgétaire existant trouvé",
            cancel: "Annuler",
            salary: "Salaire",
            fetchCalendarError: "Échec de la récupération du calendrier budgétaire",
            fetchPlanError: "Échec de la récupération du plan budgétaire",
            createSuccess: "Plan budgétaire créé avec succès",
            createError: "Échec de la création du plan budgétaire",
            createFromExistingSuccess: "Plan budgétaire créé à partir d'un plan existant",
            createFromExistingError: "Échec de la création du plan budgétaire à partir d'un plan existant",
            ...
            // Success messages
            needAdded: "Besoin ajouté avec succès",
            needAdjusted: "Besoin mis à jour avec succès",
            needRemoved: "Besoin supprimé avec succès",
            wantAdded: "Envie ajoutée avec succès",
            wantAdjusted: "Envie mise à jour avec succès",
            wantRemoved: "Envie supprimée avec succès",
            savingAdded: "Épargne ajoutée avec succès",
            savingAdjusted: "Épargne mise à jour avec succès",
            savingRemoved: "Épargne supprimée avec succès",
            incomeAdded: "Revenu ajouté avec succès",
            incomeAdjusted: "Revenu mis à jour avec succès",
            incomeRemoved: "Revenu supprimé avec succès",

            // Error messages
            needAddError: "Échec de l'ajout du besoin",
            needAdjustError: "Échec de la mise à jour du besoin",
            needRemoveError: "Échec de la suppression du besoin",
            wantAddError: "Échec de l'ajout de l'envie",
            wantAdjustError: "Échec de la mise à jour de l'envie",
            wantRemoveError: "Échec de la suppression de l'envie",
            savingAddError: "Échec de l'ajout de l'épargne",
            savingAdjustError: "Échec de la mise à jour de l'épargne",
            savingRemoveError: "Échec de la suppression de l'épargne",
            incomeAddError: "Échec de l'ajout du revenu",
            incomeAdjustError: "Échec de la mise à jour du revenu",
            incomeRemoveError: "Échec de la suppression du revenu",
            yearlyOverview: "Yearly Overview for {{year}}",
            incomesBreakdown: "Incomes Breakdown",
            needsBreakdown: "Needs Breakdown",
            wantsBreakdown: "Wants Breakdown",
