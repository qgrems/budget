export const translations = {
    en: {
        ...
        envelopes: {
            ...
            targetBudgetIsBelowZero: "Target budget is below zero.",
            ...
            targetBudgetMinLength: "The target budget must be at least 1 character long.",
            targetBudgetMaxLength: "The target budget must be at most 13 characters long.",
            targetBudgetInvalid: "The target budget must be a string representing a number with up to two decimal places (e.g., \"0.00\").",
    ...
    fr: {
        ...
        envelopes: {
            ...
            targetBudgetIsBelowZero: "Le budget cible est inférieur à zéro",
            ...
            targetBudgetMinLength: "Le budget cible doit comporter au moins 1 caractère.",
            targetBudgetMaxLength: "Le budget cible doit comporter au plus 13 caractères.",
            targetBudgetInvalid: "Le budget cible doit être une chaîne représentant un nombre avec jusqu'à deux décimales (par exemple, \"0.00\").",
