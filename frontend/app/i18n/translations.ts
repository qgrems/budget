export const translations = {
    ...
    fr: {
        ...
        envelopes: {
            ...
            targetedAmountIsBelowZero: "Le montant ciblé est inférieur à zéro",
            ...
            targetedAmountMinLength: "Le montant ciblé doit comporter au moins 1 caractère.",
            targetedAmountMaxLength: "Le montant ciblé doit comporter au plus 13 caractères.",
            targetedAmountInvalid: "Le montant ciblé doit être une chaîne représentant un nombre avec jusqu'à deux décimales (par exemple, \"0.00\").",
